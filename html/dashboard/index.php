...
// verefiqca se foi iniciada a sessão
session_start();
if(isset($_SESSION['id'])){
  // a sessão foi iniciada, faça algo aqui
    $id = $_SESSION['id'];
    // selecionar dados da tabela adm
  ...
  // a sessão não foi iniciada, redirecione o usuário de volta para a página de login
  header("Location: ../dashboard/auth/sign-in.php");
  exit();
}
// ao clicar no botao sair ele encerra a secão e volta para a pagina de login
if(isset($_POST['sair'])){
  session_destroy();
  header("Location: ../dashboard/auth/sign-in.php");
  exit();
                ...
                <li class="nav-item dropdown">
                  <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="caption ms-3 d-none d-md-block ">
                        <h6 class="mb-0 caption-title"><?php echo $nome?></h6>
                        <p class="mb-0 caption-sub-title"><?php echo $classe?></p>
                    </div>
                  </a>
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    ...
                    <form method="post" action="index.php">
                      <button id="logout" class="dropdown-item" type="submit" name="sair">logout</button>
                    </form>
