...
// fazer login com sessao pega o email e senha do formulario
if(isset($_POST['email']) && !empty($_POST['email'])) {
   ...
   //  se fizer login com sessao passando o id do usuarios
      if($sql->rowCount() > 0) {
         $sql = $sql->fetch();
         $_SESSION['id'] = $sql['id'];
   ...
   //  se nao fizer login com sessao
    else {
      //   abrir div com position absolute no centro da pagina
